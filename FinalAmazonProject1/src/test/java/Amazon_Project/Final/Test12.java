...
public void selectVariousPayementMethod() throws InterruptedException, AWTException, EncryptedDocumentException, IOException
{
	...
	checkout.selectVariousPaymentType(driver);  
